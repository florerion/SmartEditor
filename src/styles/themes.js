...
export const EDITOR_THEME_PRESETS = Object.freeze({
  light: Object.freeze({
    ...
    colors: Object.freeze({
      ...
      'color-code-function': '#953800',
      'color-code-type': '#953800',
      'color-code-literal': '#0550ae',
  ...
  dark: Object.freeze({
    ...
    colors: Object.freeze({
      ...
      'color-code-title': '#d2a8ff',
      'color-code-function': '#ffa657',
      'color-code-type': '#ffa657',
      'color-code-literal': '#79c0ff',
  ...
  sepia: Object.freeze({
    ...
    colors: Object.freeze({
      ...
      'color-code-text': '#4d3b28',
      'color-code-comment': '#8c755c',
      'color-code-keyword': '#9f3f24',
      'color-code-string': '#35606b',
      'color-code-number': '#8a5a14',
      'color-code-title': '#7b4ea3',
      'color-code-function': '#9c5b1d',
      'color-code-type': '#7a4b22',
      'color-code-literal': '#8a5a14',
  ...
  midnight: Object.freeze({
    ...
    colors: Object.freeze({
      ...
      'color-code-text': '#dfe8fb',
      'color-code-comment': '#7f93b2',
      'color-code-keyword': '#ff8fb1',
      'color-code-string': '#9be7ff',
      'color-code-number': '#ffd479',
      'color-code-title': '#b69cff',
      'color-code-function': '#ffb86b',
      'color-code-type': '#73daca',
      'color-code-literal': '#ffd479',
  ...
  solarized: Object.freeze({
    ...
    colors: Object.freeze({
      ...
      'color-code-title': '#6c71c4',
      'color-code-function': '#cb4b16',
      'color-code-type': '#b58900',
      'color-code-literal': '#d33682',
  ...
  nord: Object.freeze({
    ...
    colors: Object.freeze({
      ...
      'color-code-comment': '#81a1c1',
      'color-code-keyword': '#81a1c1',
      'color-code-string': '#a3be8c',
      'color-code-number': '#b48ead',
      'color-code-title': '#88c0d0',
      'color-code-function': '#d08770',
      'color-code-type': '#8fbcbb',
      'color-code-literal': '#b48ead',
  ...
  'high-contrast': Object.freeze({
    ...
    colors: Object.freeze({
      ...
      'color-code-keyword': '#67e8f9',
      'color-code-string': '#86efac',
      'color-code-number': '#facc15',
      'color-code-title': '#c084fc',
      'color-code-function': '#fb923c',
      'color-code-type': '#f472b6',
      'color-code-literal': '#facc15',
